...
<div class="container-fluid">
  <div class="row">
    <div class="col-md-6">
      <div class="card">
        <div class="card-header">Upload Quotas</div>
        <div class="card-body">
          @if ($errors->any())
    ...
    <div class="col-md-6">
      <div class="card">
        <div class="card-header">Recent Imports (Quotas)</div>
            ...
            <tbody>
              @forelse($recent as $imp)
                <tr>
                  ...
                  <td>
                    <a class="btn btn-sm btn-outline-primary" href="{{ route('admin.imports.quotas.preview', $imp) }}">Preview</a>
                  </td>
                </tr>
              @empty
