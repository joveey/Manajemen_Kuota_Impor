        ...
        <div class="card-body">
            <form method="GET" class="row g-3 align-items-end">
                <div class="col-xl-3 col-md-4">
                    ...
                    <select name="user_id" class="form-select select2" data-placeholder="All Users">
                ...
                <div class="col-xl-2 col-md-3">
                    ...
                    <select name="method" class="form-select">
                        ...
                        <option value="create" @selected(request('method')==='create')>Add Data</option>
                        <option value="update" @selected(request('method')==='update')>Change Data</option>
                        <option value="delete" @selected(request('method')==='delete')>Delete Data</option>
                    </select>
                </div>
                <div class="col-xl-2 col-md-3">
                    <label class="form-label">Period</label>
                    <select name="range" class="form-select" id="rangeSelect">
                        <option value="" @selected(request('range')==='')>All</option>
                        <option value="today" @selected(request('range')==='today')>Today</option>
                        <option value="2d" @selected(request('range')==='2d')>2 Days</option>
                        <option value="7d" @selected(request('range')==='7d')>7 Days</option>
                        <option value="15d" @selected(request('range')==='15d')>15 Days</option>
                        <option value="30d" @selected(request('range')==='30d')>30 Days</option>
                    </select>
                </div>
                <div class="col-xl-2 col-md-3">
                ...
                <div class="col-xl-5 col-md-6">
                    ...
                    <input type="text" name="q" value="{{ request('q') }}" class="form-control" placeholder="Search user, feature, page, IP...">
                </div>
                <div class="col-xl-2 col-md-3">
            ...
            <table class="table table-modern align-middle mb-0">
                ...
                @forelse($logs as $log)
                    <tr>
                        ...
                        <td class="text-nowrap" title="{{ $log->route_name }}">{{ str_replace(['�?"','�?�'], [' - ', ' • '], audit_activity_label($log->route_name, $log->method, $log->description)) }}</td>
                        ...
                        <td style="max-width: 480px;">
                            ...
                            @else
                                <button type="button" class="btn btn-sm btn-outline-primary" data-bs-toggle="modal" data-bs-target="#logModal-{{ $log->id }}">View</button>
                                    ...
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-6">
                                                <div class="text-muted small">IP & Device</div>
                                                <div>{{ $log->ip_address }} — <span class="text-muted">{{ Str::limit($log->user_agent, 80) }}</span></div>
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="mb-2 fw-semibold">Submitted Data</div>
                    ...
                    <tr>
                        <td colspan="7">
                            <div class="audit-empty">
                                ...
                                <div class="mb-1">No activity recorded yet.</div>
                                <div class="small">Perform create/update/delete actions then return to this page.</div>
                            </div>
                        </td>
                    </tr>
                @endforelse
...
(function(){
  ...
  function applyRange(){
    ...
    else if(v==='15d'){ const f=new Date(t); f.setDate(t.getDate()-14); from=f; to=t; }
