    ...
    <div class="row g-3">
      @php
        $steps = [
          ...
          ['label'=>'GR (Actual)','value'=>number_format($metrics['gr_qty'] ?? 0),'hint'=>'Received (last 30 days)','route'=>\Illuminate\Support\Facades\Route::has('admin.imports.gr.index') ? route('admin.imports.gr.index') : '#'],
        ];
      @endphp
      @foreach($steps as $s)
